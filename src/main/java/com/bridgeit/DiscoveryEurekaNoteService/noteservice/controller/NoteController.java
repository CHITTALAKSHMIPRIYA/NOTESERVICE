...
package com.bridgeit.DiscoveryEurekaNoteService.noteservice.controller;
...
import com.bridgeit.DiscoveryEurekaNoteService.noteservice.repository.IFeign;
import com.bridgeit.DiscoveryEurekaNoteService.noteservice.service.INoteService;
...
public class NoteController {
	...
	public ResponseEntity<String> createNote(@RequestBody NoteDto note,@RequestHeader("token") String token,HttpServletRequest request)
		...
		String id = noteService.createNote(note, userId);
		LOG.info(REs_ID);
		LOG.info("created note successfully");
		return new ResponseEntity<>("Note created Successfully:"+id, HttpStatus.OK);
	}
	...
	public ResponseEntity<String> updateNote(@PathVariable String noteId, @RequestBody NoteDto note,
			@RequestHeader("token") String token,HttpServletRequest request) throws TodoException {
	...
	public ResponseEntity<String> unpinNote(@RequestParam("noteId") String noteId, @RequestHeader("token") String token,HttpServletRequest request )
			throws TodoException {
		LOG.info(REQ_ID);
	...
	public ResponseEntity<?> addImage(@RequestParam("url") String url,HttpServletRequest request,@RequestHeader("token") String token,@RequestParam("noteId") String noteId) throws TodoException, IOException {
		LOG.debug("Adding an image to an note");
		LOG.info(REQ_ID);
		LOG.info("adding an image to note");
		String userId=request.getHeader("userId");
		Optional<Note> displayData = noteService.addimageToNote(url, userId, noteId);
		LOG.info(REs_ID);
		LOG.info("added an image");
		return new ResponseEntity<>(displayData, HttpStatus.OK);
	}
	/**
	 * @return
	 */
	@GetMapping(value="/displayuser",headers="Accept=application/json")
